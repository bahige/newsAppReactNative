        ...
        <ScrollView>
            <HeadlineDetailsTitleContainer>
                ...
                <HeadlineDetailsDateAndSource> 
                    <Moment format="MMMM DD, YYYY" date={headline.publishedAt}></Moment> / <Moment format="h:mm:ss a" date={headline.publishedAt}></Moment> / {headline.source && headline.source.name}
                </HeadlineDetailsDateAndSource>
